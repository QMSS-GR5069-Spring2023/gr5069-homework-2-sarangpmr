...
data(nba) # Load the data file

class(nba) # Check that it's returned as a data.frame

head(nba, 10) # View the first 10 rows of our data to see it's loaded correctly
```
