...
```{r}
# The lebronPPG() function should return four values: player, year, g, pts, ppg
# The function will not return anything if you provide a year value outside the range of his career

lebronPPG(2001) # This should return an error message with the correct year range

lebronPPG(2006) # This should return our values
```
